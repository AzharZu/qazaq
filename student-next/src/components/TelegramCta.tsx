...
export default function TelegramCta({ className = "", ...rest }: TelegramCtaProps) {
  return (
    <section
      className={`rounded-2xl border border-white/10 bg-slate-900/70 backdrop-blur p-6 shadow-lg transition hover:shadow-2xl md:p-7 ${className}`}
    >
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 self-start rounded-xl bg-[#229ED9] px-5 py-3 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5 hover:bg-[#1f8cc6]"
        >
