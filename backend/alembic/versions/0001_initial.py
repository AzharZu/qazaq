...
def upgrade():
    ...
    if bind.dialect.name != "sqlite":
        op.execute("SELECT setval('courses_id_seq', (SELECT MAX(id) FROM courses))")
        op.execute("SELECT setval('modules_id_seq', (SELECT MAX(id) FROM modules))")
        op.execute("SELECT setval('lessons_id_seq', (SELECT MAX(id) FROM lessons))")
        op.execute("SELECT setval('lesson_blocks_id_seq', (SELECT MAX(id) FROM lesson_blocks))")
        op.execute("SELECT setval('flashcards_id_seq', (SELECT MAX(id) FROM flashcards))")
        op.execute("SELECT setval('quizzes_id_seq', (SELECT MAX(id) FROM quizzes))")
